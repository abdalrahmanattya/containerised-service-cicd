...
## Issues 001–003 application commands
...
Issue 004 will add structured logging. Issue 005 will add Docker commands.
Issue 006 will document the matching CI and vulnerability-scan commands.
